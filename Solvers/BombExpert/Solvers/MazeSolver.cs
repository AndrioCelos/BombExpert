...
namespace BombExpert.Solvers {
	public class MazeSolver : IModuleSolver {
		...
		private static readonly Cache<int, Maze[]> mazeCache = new Cache<int, Maze[]>(Utils.CacheSize, GetMazesInternal);
		...
		public static bool TryGetMazeFromMarker(Maze[] mazes, int markerX, int markerY, out Maze maze) {
